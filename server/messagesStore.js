...
DOMPurify.addHook('afterSanitizeAttributes', (node) => {
  // A way to implement a automatic CDN usage in the purify process by replacing all src attributes of images for example
...
const addMessage = async (_message) => {
  ...
  message.message = DOMPurify.sanitize(marked(message.message), {
