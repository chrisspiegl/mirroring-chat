  ...
  div
    v-app-bar(app, clipped-left, dense)
      ...
      v-toolbar-items.hidden-sm-and-down
        ...
        v-btn(to="/login", v-if="!loggedIn") Login
        v-btn(to="/logout", v-if="loggedIn") Logout
    ...
    v-navigation-drawer(v-model="miniVariant", app, top, clipped, :permanent="!isMobile", :mini-variant="miniVariant && !isMobile")
      vue-scroll
        v-list(nav, dense)
          ...
          v-list-item.hidden-md-and-up(v-if="loggedIn", link, to="/logout")
            v-list-item-action
      ...
      template(v-slot:append)
        ...
        //-   v-list-item.hidden-md-and-up(v-if="loggedIn && activated", link, to="/logout")
        //-       v-list-item-action
        //-         v-icon(title="Logout") $logout
        //-       v-list-item-content
        //-         v-list-item-title Logout
